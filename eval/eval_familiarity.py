...
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), '..', 'results', 'familiarity')
CONGESTION = {"AB": 6}
NUM_TRIPS = 10
DRIVERS = [
...
fig, ax = visualize_network_with_traffic(init_network, "Familiarity Test (AB=51km/h, 6/10 congestion)")
